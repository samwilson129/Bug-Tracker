...
public class LandingView extends VerticalLayout {
    ...
    private VerticalLayout createHeroSection() {
        ...
        Paragraph heroSubtitle = new Paragraph("A comprehensive bug tracking system for development teams of all sizes");
    ...
    private VerticalLayout createHowItWorksSection() {
        ...
        Div step2 = createStepCard("2", "Assign & Prioritize", "Managers review, prioritize, and assign bugs to developers.");
