...
public class Project {
    ...
    public Project(int id, String name, String description, List<String> bugs, int managerId, List<Integer> developerIds) {
        this.id = id;
        this.name = name;
    ...
    //         System.out.println("Bug in getBugsAsJsonString: "+objectMapper.writeValueAsString(bugs)); // bugs is the List<String>
