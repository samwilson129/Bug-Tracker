...
public class Bug {
    ...
    public Bug(int id,String title,String description,BugStatus bugstatus,LocalDateTime createdAt,LocalDateTime updatedAt,String assignedTo,String reportedBy){
        this.id=id;
        this.title=title;
